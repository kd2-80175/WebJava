				...
				if(type==null || type.equals("all")) 
				 ...
				 list=revDao.getSharedWithUser(uid);
					for(Reviews r:list) {
						...
						out.printf("<td>%s</td>\r\n", r.getRating());
						out.printf("<td>%s</td>\r\n",r.getReview());
						out.printf("<td><a href='revedit?id=%s'><img src='edit.png' alt='Edit' width='24' height='24'/></a> <a href='revdel?id=%s'><img src='delete.png' alt='Delete' width='24' height='24'/></a> <a href='revshare?id=%s'><img src='share.jpg' alt='Share' width='24' height='24'/></a></td>\r\n", r.getId(), r.getId(),r.getId());
						out.println("</tr>");
					}
